    ...
    DELAY: DelayNs,
{
    ...
    pub async fn get_one_time_measurement(
        &mut self,
        ...
        self.delay.delay_ms(safe_delay).await;

        self.get_current_measurement(resolution).await
    }
    ...
    pub async fn get_current_measurement(
        &mut self,
        resolution: Resolution,
    ) -> Result<f32, BH1750Error<I2C::Error>> {
    ...
    pub async fn set_measurement_time_register(
        &mut self,
        value: u8,
    ) -> Result<(), BH1750Error<I2C::Error>> {
